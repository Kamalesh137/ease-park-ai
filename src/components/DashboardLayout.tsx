import { Car, LayoutDashboard, ClipboardList, BarChart3, Settings, Home, Menu, X } from "lucide-react";
        ...
        <div className="p-4 border-t">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm">
              ...
              <p className="text-muted-foreground text-xs">admin@parkvision.ai</p>
            </div>
          </div>
        </div>
      </aside>
